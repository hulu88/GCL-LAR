...
def load_graph_data(dataset_name, show_details=False):
    ...
    return torch.tensor(feat).float(), label, torch.tensor(adj).float(), node_num, cluster_num
...
def phi(feature, true_labels, cluster_num):
    predict_labels, centers = kmeans(X=feature, num_clusters=cluster_num, distance="euclidean", device="cpu") ##cuda
